...
func Systems(app *bevi.App) {
	...
	// System: publishPlayerQuit (from plugin.go)
	{
		...
		meta := bevi.SystemMeta{Access: acc, Set: "dragonfly", Before: nil, After: nil}
		app.AddSystem(bevi.PreUpdate, "publishPlayerQuit", meta, func(ctx context.Context, w *ecs.World) {
	...
	// System: handlePlayerRemoval (from plugin.go)
	{
		...
		bevi.AccessEventRead[playerRemove](&acc)
		meta := bevi.SystemMeta{Access: acc, Set: "dragonfly", Before: nil, After: nil}
		app.AddSystem(bevi.PostUpdate, "handlePlayerRemoval", meta, func(ctx context.Context, w *ecs.World) {
