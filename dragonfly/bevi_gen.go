...
// Generated at 2025-11-17T23:43:48-06:00
...
func Systems(app *bevi.App) {
	...
	_er_6 := bevi.ReaderFor[PlayerQuit](app.Events())
	...
	// System: emitPlayerQuit (from plugin.go)
	{
		...
		app.AddSystem(bevi.PreUpdate, "emitPlayerQuit", meta, func(ctx context.Context, w *ecs.World) {
			emitPlayerQuit(_res_1, _er_4, _ew_5)
		})
	}
	...
	// System: finalizePlayerQuit (from plugin.go)
	{
		...
		bevi.AccessResRead[Server](&acc)
		meta := bevi.SystemMeta{Access: acc, Set: "dragonfly", Before: []string{"emitPlayerQuit"}, After: nil}
		app.AddSystem(bevi.PostUpdate, "finalizePlayerQuit", meta, func(ctx context.Context, w *ecs.World) {
			finalizePlayerQuit(w, _res_1, _er_6)
		})
	}
