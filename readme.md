...
go install github.com/oriumgames/bevi/cmd/gen@v0.2.1
```
...
go run github.com/oriumgames/bevi/cmd/gen@v0.2.1 -root .
```
...
```bash
go run github.com/oriumgames/bevi/cmd/gen@v0.2.1 -root . -write
```
