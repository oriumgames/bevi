...
go install github.com/oriumgames/bevi/cmd/gen@v0.1.6
```
...
go run github.com/oriumgames/bevi/cmd/gen@v0.1.6 -root .
```
...
```bash
go run github.com/oriumgames/bevi/cmd/gen@v0.1.6 -root . -write
```
