...
go install github.com/oriumgames/bevi/cmd/gen@v0.1.0
```
...
go run github.com/oriumgames/bevi/cmd/gen@v0.1.0 -root .
```
...
```bash
go run github.com/oriumgames/bevi/cmd/gen@v0.1.0 -root . -write
```
