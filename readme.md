...
```bash
go get github.com/oriumgames/bevi@v0.1.5
```
...
go install github.com/oriumgames/bevi/cmd/gen@v0.1.5
```
...
go run github.com/oriumgames/bevi/cmd/gen@v0.1.5 -root .
```
...
```bash
go run github.com/oriumgames/bevi/cmd/gen@v0.1.5 -root . -write
```
