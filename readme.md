...
go install github.com/oriumgames/bevi/cmd/gen@v0.1.7
```
...
go run github.com/oriumgames/bevi/cmd/gen@v0.1.7 -root .
```
...
```bash
go run github.com/oriumgames/bevi/cmd/gen@v0.1.7 -root . -write
```
