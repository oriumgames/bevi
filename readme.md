...
```bash
go get github.com/oriumgames/bevi@v0.2.0
```
...
go install github.com/oriumgames/bevi/cmd/gen@v0.2.0
```
...
go run github.com/oriumgames/bevi/cmd/gen@v0.2.0 -root .
```
...
```bash
go run github.com/oriumgames/bevi/cmd/gen@v0.2.0 -root . -write
```
